...
class Settings::HostingsControllerTest < ActionDispatch::IntegrationTest
  ...
  teardown do
    ...
    %i[anthropic_access_token anthropic_base_url anthropic_model gemini_api_key gemini_model llm_provider twelve_data_api_key openai_access_token external_assistant_token rentcast_api_key realie_api_key].each do |key|
