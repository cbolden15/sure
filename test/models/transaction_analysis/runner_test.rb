  ...
  private
    ...
    def tool_call(name, **arguments)
      response = Provider::LlmConcept::ChatResponse.new(
        ...
        model: "test-model",
        messages: [],
        function_requests: [ Provider::LlmConcept::ChatFunctionRequest.new(id: SecureRandom.uuid, call_id: SecureRandom.uuid, function_name: name, function_args: arguments.to_json) ]
      )
